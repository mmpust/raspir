...
# do not edit!
input_file_wochenende_short=${input_file_wochenende%.ndp.trm.s.mq30.mm.dup.calmd.bam.txt.rep.us.csv}
input_file_raspir=${input_file_wochenende_short}_final_stats.csv
